...
Please keep discussion to the first iteration introduced by this proposal. Future enhacements can be tracked in the WECG [issue tracker](https://github.com/w3c/webextensions/issues).